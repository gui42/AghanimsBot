...
Once thats done, you can creat the file "token.txt" and save your token there, now you just have the compile the main.py and that's it! Add your own bot to your chats!</p>
